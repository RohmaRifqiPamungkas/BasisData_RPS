...
class Auth extends CI_Controller
{
    ...
    //     if ($this->form_validation->run() == false) {
    //         $data['title'] = 'Amikom User Registration';
    //         $this->load->view('templates/auth_header', $data);
    ...
    private function _registrationMiddleware()
    {
        $this->form_validation->set_rules('email', 'Email', 'required|trim|valid_email|is_unique[user.email]', [
    ...
    public function registration()
    {
        ...
        // Run the registration middleware
        if (!$this->_registrationMiddleware()) {
    ...
    public function createDosenAccount()
    {
        ...
        // Continue with your Dosen registration logic
        $email = $this->input->post('email', true);
        $userData = [
            'email' => htmlspecialchars($email),
            'image' => 'default.jpg',
